...
function createServer() {
    ...
    server.registerTool("set-spotify-credentials", z.object({
    ...
    // Search tracks
    server.registerTool("search-tracks", z.object({
    ...
    // Create playlist
    server.registerTool("create-playlist", z.object({
    ...
    server.registerTool("add-tracks-to-playlist", z.object({
    ...
    // Get recommendations
    server.registerTool("get-recommendations", z.object({
        seedTracks: z
            .array(z.string())
            .max(5)
